...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] sub = {"This_sub", "That_sub", "Who_sub", "Whom_sub", "This_sub", "That_sub",
                "Who_sub", "Whom_sub", "This_sub", "That_sub", "Who_sub", "Whom_sub"};

        /*ArrayAdapter adapter = new ArrayAdapter(this, R.layout.list, R.id.lst_txt, names);

        list.setAdapter(adapter);
        */
        CustomAdapter adapter = new CustomAdapter(this, names, sub, imgs);
        list.setAdapter(adapter);
